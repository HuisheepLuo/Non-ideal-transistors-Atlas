...
# train_param_group = {
#     'mu1_power': np.linspace(0.1, 0.5, 500), 
#     'P0': np.logspace(-2, 0, 500), 
#     'barrier': np.linspace(0.1, 1, 500),
#     'ion_multiple': np.linspace(0.02, 20, 500), 
# }
